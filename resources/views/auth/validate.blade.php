...
<div class="panel-body" id="validate">
    ...
    <form class="form-horizontal" role="form" method="GET" action="/register/{{$user_type}}">
        {{ csrf_field() }}

        <input type="hidden" name="user_type" value="{{$user_type}}">

        <div class="form-group">
            <label for="hs_id_number" class="col-sm-4 control-label">High School ID Number</label>
        ...
        <center> <b> Parent/Guardian Information </b></center><br>
            ...
            <div class="form-group">
                <label for="guardian_name" class="col-sm-4 control-label">Name</label>
            ...
            <div class="form-group">
                <label for="guardian_mobile_number" class="col-sm-4 control-label">Mobile Number</label>
            ...
            <div class="form-group">
                <label for="guardian_email" class="col-sm-4 control-label">E-mail Address</label>
        ...
        <form class="form-horizontal" role="form" method="GET" action="/register/{{$user_type}}">
            ...
            <div class="form-group">
                <label for="ls_id_number" class="col-sm-4 control-label">Loyola Schools ID</label>
            ...
            <div class="form-group">
                <label for="obf_email" class="col-sm-4 control-label">OBF E-mail Address</label>
        ...
        <form class="form-horizontal" role="form" method="GET" action="/register/{{$user_type}}">
            ...
            <div class="form-group">
                <label for="staff_id_number" class="col-sm-4 control-label">Employee ID</label>
            ...
            <div class="form-group">
                <label for="ateneo_email" class="col-sm-4 control-label">Ateneo E-mail Address</label>
